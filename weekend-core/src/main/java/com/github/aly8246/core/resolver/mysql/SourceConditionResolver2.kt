...
// * @version: ：V
// */
//class SourceConditionResolver2 {
//
//    open fun sourceBuildCondition(plainSelect: PlainSelect): List<Condition> {
//        var rootExpression: BinaryExpression = plainSelect.where as BinaryExpression
...
//
//            //如果为结束节点才进行条件拆解，否则继续递归
//            //遍历左子节点和右子节点
//            if (nodeIsEnd(leftExpression)) {
//                val condition = deconstructExpressionTree(leftExpression)
//                if (condition != null) {
//                    conditionList.add(condition)
//                }
//                when (rightExpression) {
//                    is Parenthesis -> println("是一个表达式:$rightExpression")
//                    else -> rootExpression = rightExpression as BinaryExpression
//                }
//            }
//            if (nodeIsEnd(rightExpression)) {
//                val condition = deconstructExpressionTree(rightExpression)
//                if (condition != null) {
//                    conditionList.add(condition)
//                }
//                when (leftExpression) {
//                    is Parenthesis -> println("是一个表达式:$leftExpression")
//                    else -> rootExpression = leftExpression as BinaryExpression
//                }
//            }
//            when {
//                (nodeIsEnd(leftExpression) && nodeIsEnd(rightExpression)) -> break@loop
//            }
//        }
//
...
//            is BinaryExpression -> {
//                when (expression) {
//                    is MinorThan, is AndExpression, is NotEqualsTo, is NotEquals -> {
